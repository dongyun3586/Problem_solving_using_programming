...
Poly = collections.namedtuple('Poly', ['term', 'coef'])  # namedtuple로 희소 다항식 표현
...
def addSparsePoly(p1, p2):
    ...
    if p1.term:
        for _ in p1.term:
            ...
            p3.countcoef.append(p1.coef.pop(0))
    if p2.term:
        for _ in p2.term:
            p3.term.append(p2.term.pop(0))
            p3.countcoef.append(p2.coef.pop(0))
